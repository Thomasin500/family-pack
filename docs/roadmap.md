...
_Built April 14, 2026. Not yet committed._
...
_Make the trip workspace powerful._
...
_The features that make Family Pack feel smart and fun._
...
| —   | Shared vs personal weight breakdown | Expandable balance bar showing shared gear weight vs personal essentials vs luxury/activity items per person. Smart summary: "Shared gear is balanced. Thomas's extra 3.4 lb is fishing gear." Separates fairness (shared distribution) from personal choice (activity gear). Level 1: smarter balance bar. Level 2: stacked breakdown panel. Level 3: rebalance suggestions when shared gear is lopsided. Uses category-based detection (core vs activity categories) initially, activity tags later. | M      | Not started |
...
_Round out the rough edges from Tier 1 and Tier 2._
...
| User profile UI              | Body stats form (weight, height, birth date), pet profile editing, profile photo upload           | S      | Not started |
...
_Onboarding from other apps + power-user organization._
...
_Upgrade the skeleton loadout view, add deeper insights._
