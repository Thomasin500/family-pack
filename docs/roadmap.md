...
| 💡 Post-trip report      | 5-star pack rating, free-text "what worked / what I'd change", MVP item, LVP item, actual distance / vert / duration. Compared against planned fields from Phase 8. **From a user suggestion (Bear Family).**                                                                                              | M      | Not started |
